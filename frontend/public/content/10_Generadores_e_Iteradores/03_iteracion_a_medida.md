...
*Observación:* para que esto funcione, tu clase `Camion` tiene que haber implementado el operador `in`. Controlá que tu solución al ejercicio [Ejercicio 10.3](/programa/units/generadores-e-iteradores/protocolo-iteracion#ejercicio-103-un-iterador-adecuado) implemente el operador `__contains__()`.
