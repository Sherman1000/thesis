...
1. El archivo `informe_final.py` del [Ejercicio 10.2](/programa/units/generadores-e-iteradores/protocolo-iteracion#ejercicio-102-iteracion-sobre-objetos).
2. El archivo `camion.py` del [Ejercicio 10.14](/programa/units/generadores-e-iteradores/mas-generadores#ejercicio-1014-expresiones-generadoras-como-argumentos-en-funciones) que va a jugar en la revisión de pares.
3. El archivo `vigilante.py` del [Ejercicio 10.7](/programa/units/generadores-e-iteradores/iteracion-a-medida#ejercicio-107-cambios-de-precio-de-un-camion).
4. El archivo `ticker.py` del [Ejercicio 10.15](/programa/units/generadores-e-iteradores/mas-generadores#ejercicio-1015-codigo-simple).

* Y, opcionalmente, el archivo `simulacion.py` del [Ejercicio 10.19](/programa/units/generadores-e-iteradores/predador-presa#ejercicio-1019-alcanzando-la-madurez).

<button class="btn btn-primary" onclick="window.location.pathname='unit/submission/10';">Entregar ejercicios</button>
