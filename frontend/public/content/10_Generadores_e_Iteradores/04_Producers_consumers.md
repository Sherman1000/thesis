...
Para este ejercicio, necesitás que el programa `sim_mercado.py` aún esté corriendo. Vas a usar la función `vigilar()` que escribiste en el [Ejercicio 10.7](/programa/units/generadores-e-iteradores/iteracion-a-medida#ejercicio-107-cambios-de-precio-de-un-camion)
