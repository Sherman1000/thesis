...
La mayoría de los programas usa alguna fuente de datos. En esta sección discutimos el acceso a archivos, tema que introducimos en este [video](https://youtu.be/KTCS13-Z8bI). Te dejamos también el <a href="/content/02_Estructuras_y_Funciones/arboles.py" download>código</a> y el <a href="/content/02_Estructuras_y_Funciones/arboles.csv" download>archivo</a> que usamos en el video.
