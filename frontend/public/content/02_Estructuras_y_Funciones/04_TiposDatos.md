...
Construí una función que, a partir de una lista de palabras, devuelva un diccionario geringoso. Las claves del diccionario deben ser las palabras de la lista y los valores deben ser sus traducciones al geringoso (como en el [Ejercicio 1.18](/programa/units/introduccion/cadenas#ejercicio-118-geringoso-rustico)). 
