...
Modificá el programa `hipoteca.py` del [Ejercicio 1.11](/programa/units/introduccion/numeros#ejercicio-111-bonus) de la sección anterior para que escriba su salida usando f-strings. Tratá de hacer que la salida quede bien alineada.
