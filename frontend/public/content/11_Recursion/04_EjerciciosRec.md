...
Fijate que este ejercicio es un caso particular de la función `sumar_enteros(desde, hasta)` que implementaste en el [Ejercicio 7.8](/programa/units/diseño-y-documentacion/especificacion-y-documentacion#ejercicio-78-sumas). La implementación que hiciste en el primer inciso de ese ejercicio es una forma de reemplazar la recursión por un ciclo. La implementación que hiciste en el segundo inciso es mucho más eficiente.
...
![Pascal animado](/content/11_Recursion/PascalTriangleAnimated2.gif)
...
![Hojas](/content/11_Recursion/AN.png)
