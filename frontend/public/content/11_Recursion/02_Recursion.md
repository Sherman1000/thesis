...
![Una imagen recursiva: la publicidad de Cacao Droste.](/content/11_Recursion/cartel.png)
...
La función `potencia(b, n)` que vimos cuando hablamos de invariantes en la [Sección 7.5](/programa/units/diseño-y-documentacion/especificacion-y-documentacion#invariantes-de-ciclo),
...
![Espiral a partir de la sucesión de Fibonacci](/content/11_Recursion/280px-Fibonacci_spiral_34.bmp)
...
![Árbol de llamadas para fib(5)](/content/11_Recursion/fib5.jpg)
