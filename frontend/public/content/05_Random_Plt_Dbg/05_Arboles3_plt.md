...
Usando tu trabajo en el [Ejercicio 4.16](/programa/units/listas/arboles#ejercicio-416-lista-de-altos-de-jacaranda), generá un histograma con las alturas de los Jacarandás en el dataset.
...
Escribí una función `scatter_hd(lista_de_pares)` que a partir de una lista de pares como la que generaste en el [Ejercicio 4.17](/programa/units/listas/arboles#ejercicio-417-lista-de-altos-y-diametros-de-jacaranda) genere un scatterplot para visualizar la relación entre altura y diámetro de los Jacarandás del dataset.
...
Ahora vamos a usar la función `medidas_de_especies()` definida en el [Ejercicio 4.18](/programa/units/listas/arboles#ejercicio-418-diccionario-con-medidas).
