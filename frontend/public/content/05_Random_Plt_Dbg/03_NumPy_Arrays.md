...
![./np_array.png](/content/05_Random_Plt_Dbg/np_array.png)
...
![./np_indexing.png](/content/05_Random_Plt_Dbg/np_indexing.png)
...
![./np_array_dataones.png](/content/05_Random_Plt_Dbg/np_array_dataones.png)
...
![./np_data_plus_ones.png](/content/05_Random_Plt_Dbg/np_data_plus_ones.png)
...
![./np_sub_mult_divide.png](/content/05_Random_Plt_Dbg/np_sub_mult_divide.png)
...
![./np_multiply_broadcasting.png](/content/05_Random_Plt_Dbg/np_multiply_broadcasting.png)
...
![./np_aggregation.png](/content/05_Random_Plt_Dbg/np_aggregation.png)
...
![./np_create_matrix.png](/content/05_Random_Plt_Dbg/np_create_matrix.png)
...
![./np_matrix_indexing.png](/content/05_Random_Plt_Dbg/np_matrix_indexing.png)
...
![./np_matrix_aggregation.png](/content/05_Random_Plt_Dbg/np_matrix_aggregation.png)
...
![./np_matrix_aggregation_row.png](/content/05_Random_Plt_Dbg/np_matrix_aggregation_row.png)
...
![./np_matrix_arithmetic.png](/content/05_Random_Plt_Dbg/np_matrix_arithmetic.png)
...
![./np_matrix_broadcasting.png](/content/05_Random_Plt_Dbg/np_matrix_broadcasting.png)
...
![./np_ones_zeros_random.png](/content/05_Random_Plt_Dbg/np_ones_zeros_random.png)
...
![./np_ones_zeros_matrix.png](/content/05_Random_Plt_Dbg/np_ones_zeros_matrix.png)
...
![./np_MSE_formula.png](/content/05_Random_Plt_Dbg/np_MSE_formula.png)

Implementar esta fórmula es simple y directo con numpy:

![./np_MSE_implementation.png](/content/05_Random_Plt_Dbg/np_MSE_implementation.png)
...
![./np_mse_viz1.png](/content/05_Random_Plt_Dbg/np_mse_viz1.png)
...
![./np_mse_viz2.png](/content/05_Random_Plt_Dbg/np_mse_viz2.png) ![./np_MSE_explanation2.png](/content/05_Random_Plt_Dbg/np_MSE_explanation2.png)
...
Ampliá el código de la función `medir_temp(n)` en tu archivo `termometro.py` que escribiste en el [Ejercicio 5.6](/programa/units/aleatoriedad/random#ejercicio-56-gaussiana) para que además de devolver las temperaturas simuladas, guarde el vector con estas temperaturas en el directorio `Data` de tu carpeta de ejercicios, en un archivo llamado `temperaturas.npy`. Hacé que corra `n = 999` veces. 
