...
Copiá el programa `informe.py` que escribiste antes (ver [Ejercicio 2.18](/programa/units/estructuras-y-funciones/contenedores#ejercicio-218-balances)) a la carpeta de ejercicios de la clase actual, y modificalo para que use esta técnica para elegir las columnas a partir de sus encabezados.
