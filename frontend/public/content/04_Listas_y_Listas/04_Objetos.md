...
![Referencias](/content/04_Listas_y_Listas/referencias.png)
...
Esto es lo mismo que pasaba en el [Ejercicio 3.5](/programa/units/datos/errores#ejercicio-35-pisando-memoria).
...
![Copias superficiales](/content/04_Listas_y_Listas/shallow.png)
