...
![Partes del Spyder, un IDE para Python que facilita el debugging](/content/04_Listas_y_Listas/spyder-partes.png)   
...
![Menu Debug, en Spyder](/content/04_Listas_y_Listas/debug_menu.png)
...
Vamos a volver a analizar el siguiente código, similar al del [Ejercicio 3.1](/programa/units/datos/errores#ejercicio-31-semantica) para que veas la utilidad del debugger:
...
![Menu Debug, en Spyder](/content/04_Listas_y_Listas/debug2.jpg)
...
![Menu Debug, en Spyder](/content/04_Listas_y_Listas/debug3.jpg)
...
![Menu Debug, en Spyder](/content/04_Listas_y_Listas/debug4.jpg)
...
![Menu Debug, en Spyder](/content/04_Listas_y_Listas/debug5.jpg)
...
Te dejamos un [video](https://youtu.be/ak5wqGwCb5M) (un poco largo) donde usamos el debugger y repasamos el [Ejercicio 3.17](/programa/units/datos/formato#ejercicio-317-tablas-de-multiplicar) de tablas de multipicar.
...
Siguiendo con los ejemplos del [Ejercicio 3.1](/programa/units/datos/errores#ejercicio-31-semantica), usá el debugger para analizar el siguiente código:
