...
Una tarea que realizamos una y otra vez es procesar los elementos de una lista. En esta sección introducimos la definición de listas por comprensión que es una herramienta potente para hacer exactamente eso. Si querés, podés ver este [video breve](https://youtu.be/Ewauirj_leo) donde introducimos el tema, o también podés optar por un [video extendido](https://youtu.be/h5EnktOrsRQ), donde usamos <a href="/content/04_Listas_y_Listas/listas.py" download>este código</a>.
