...
Copiá el archivo `fileparse.py` al directorio de ejercicios de la clase actual. La última versión que deberías tener, es la correspondiente al [Ejercicio 6.9](/programa/units/organizacion-y-complejidad/funciones#ejercicio-69-trabajando-sin-encabezados).
