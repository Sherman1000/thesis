...
* [8.1 Introducción](/programa/units/fechas-carpetas-y-pandas/introduccion)
* [8.2 Manejo de fechas y horas](/programa/units/fechas-carpetas-y-pandas/fechas)
* [8.3 Manejo de archivos y carpetas](/programa/units/fechas-carpetas-y-pandas/archivos-y-directorios)
* [8.4 Ordenar archivos en Python](/programa/units/fechas-carpetas-y-pandas/ordenando-archivos)
* [8.5 Introducción a Pandas](/programa/units/fechas-carpetas-y-pandas/pandas)
* [8.6 Series temporales](/programa/units/fechas-carpetas-y-pandas/series)
* [8.7 Cierre de la clase](/programa/units/fechas-carpetas-y-pandas/cierre-de-clase)
